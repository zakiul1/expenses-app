<nav class="fixed z-30 w-full bg-sky-50 border-b border-gray-200 dark:bg-gray-800 dark:border-gray-700">
    <div class="px-3 py-3 lg:px-5 lg:pl-3">
        <div class="flex items-center justify-between">
            ...
            class="p-2 mr-1 text-gray-600 rounded cursor-pointer lg:hidden hover:text-gray-900 hover:bg-sky-100 focus:bg-sky-100 dark:focus:bg-sky-700 focus:ring-2 focus:ring-sky-100 dark:focus:ring-gray-700 dark:text-gray-400 dark:hover:bg-gray-700 dark:hover:text-white">
        ...
        {{--  Menu --}}
                ...
                <a href="{{ route('home') }}" class="flex items-center md:mr-24">
                    <div class=" bg-white rounded-full p-1  dark:bg-gray-500 dark:rounded-full mr-2">
                        <img src="{{ asset('assets/logo.png') }}" class="w-6 h-6 md:w-7 md:h-7  object-cover" alt="App Logo">
                    </div>
                    <span
