                        ...
                        <div class="grid grid-cols-3 ">
                            ...
                            <div class="col-span-6 sm:col-span-3">
                                ...
                                <input type="email" name="email" id="createCompanyEmail"
                                    class="shadow-sm bg-gray-50 border border-gray-300 text-gray-900 sm:text-sm rounded-lg focus:ring-primary-500 focus:border-primary-500 block w-full p-2.5 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-primary-500 dark:focus:border-primary-500"
                                    >
                                <p id="create_Company_email_error" class="mt-2 text-xs text-red-600 dark:text-red-400">
                                </p>
                            </div>
                            ...
                            <div class="col-span-6 sm:col-span-3">
                                ...
                                <input type="text" name="phone_number" id="createCompanyPhoneNumber"
                                    class="shadow-sm bg-gray-50 border border-gray-300 text-gray-900 sm:text-sm rounded-lg focus:ring-primary-500 focus:border-primary-500 block w-full p-2.5 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-primary-500 dark:focus:border-primary-500"
                                    >
                                <p id="create_Company_phone_number_error" class="mt-2 text-xs text-red-600 dark:text-red-400">
                                </p>
                            </div>
                            {{-- Company Phone Number --}}
                        ...
                        <div class="grid grid-cols-3 ">
                            ...
                            <div class="col-span-6 sm:col-span-3">
                                ...
                                <input type="email" name="email" id="updateCompanyEmail"
                                    class="shadow-sm bg-gray-50 border border-gray-300 text-gray-900 sm:text-sm rounded-lg focus:ring-primary-500 focus:border-primary-500 block w-full p-2.5 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-primary-500 dark:focus:border-primary-500"
                                    >
                                <p id="update_Company_email_error" class="mt-2 text-xs text-red-600 dark:text-red-400">
                                </p>
                            </div>
                            {{-- Company Phone Number --}}
                            <div class="col-span-6 sm:col-span-3">
                                ...
                                <input type="text" name="phone_number" id="updateCompanyPhone"
                                    class="shadow-sm bg-gray-50 border border-gray-300 text-gray-900 sm:text-sm rounded-lg focus:ring-primary-500 focus:border-primary-500 block w-full p-2.5 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-primary-500 dark:focus:border-primary-500"
                                    >
                                <p id="update_Company_phone_number_error" class="mt-2 text-xs text-red-600 dark:text-red-400">
                                </p>
                            </div>
                            {{-- Company Phone Number --}}
