        ...
        <div class="w-full mb-1">
            <div class="mb-4">
                ...
                <div class="flex justify-between pb-4  border-b border-gray-300">
                    <h1 class=" text-2xl font-semibold text-gray-600 dark:text-white">Invoices List</h1>
                                ...
                                @if ($invoices)
                                    @foreach ($invoices as $invoice)
                                        <tr class="hover:bg-gray-100 dark:hover:bg-gray-700">
                                            ...
                                            <td
                                                class="p-4 text-base text-center font-medium text-gray-900 whitespace-nowrap dark:text-white">
                                               {{--  {{ $invoice->factory_value }} --}}<span class="bg-purple-100 text-purple-800 text-xs font-medium mr-2 px-2.5 py-0.5 rounded-md border border-purple-100 dark:bg-gray-700 dark:border-purple-500 dark:text-purple-400">Runing</span>
                                            </td>
                                            ...
                                            <td class="p-4 text-right space-x-2 whitespace-nowrap">
                                             <a href="{{ route('invoice.details',['id' => $invoice->id])}}">
                                                ...
                                                <button type="button" {{-- onclick="deleteFactoryFunc({{ $invoice->id }})" --}}
                            ...
                            <div class="grid grid-cols-6 gap-6">
                                ...
                                <div class="col-span-6 sm:col-span-3">
                                    <label for="createInvoiceValue"
                                        class="block mb-2 text-sm font-medium text-gray-900 dark:text-white">Invoice Value</label>
                                    <input type="number" name="invoice_value" id="createInvoiceValue"
                                        class="shadow-sm bg-gray-50 border border-gray-300 text-gray-900 sm:text-sm rounded-lg focus:ring-primary-500 focus:border-primary-500 block w-full p-2.5 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-primary-500 dark:focus:border-primary-500">
                                    <p id="create_invoice_value_error" class="mt-2 text-xs text-red-600 dark:text-red-400">
                                    </p>
                                </div>
                                {{-- Select Buyer  --}}
                                <div class="col-span-6 sm:col-span-3">

                                    <label for="createInvoiceBuyerId" class="block mb-2 text-sm font-medium text-gray-900 dark:text-white">Chose a Buyer</label>
                                    <select id="createInvoiceBuyerId" name="buyer_id" class="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full p-2.5 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-blue-500 dark:focus:border-blue-500">
                                ...
                                <div class="col-span-6 sm:col-span-3">
                                    ...
                                    <label for="createInvoiceBuyerId" class="block mb-2 text-sm font-medium text-gray-900 dark:text-white">Chose a Factory</label>
                                    <select id="createInvoiceBuyerId" name="factory_id" class="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full p-2.5 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-blue-500 dark:focus:border-blue-500">
                                ...
                                <div class="col-span-6 sm:col-span-3">
                                    <label for="createInvoiceFactoryValue"
                                        class="block mb-2 text-sm font-medium text-gray-900 dark:text-white">Factory Value</label>
                                    <input type="number" name="factory_value" id="createInvoiceFactoryValue"
                                        class="shadow-sm bg-gray-50 border border-gray-300 text-gray-900 sm:text-sm rounded-lg focus:ring-primary-500 focus:border-primary-500 block w-full p-2.5 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-primary-500 dark:focus:border-primary-500">
                                    <p id="create_factory_value_error" class="mt-2 text-xs text-red-600 dark:text-red-400">
                                    </p>
                                </div>
                                {{-- Invoice Buyer Bank bank_id --}}
                                <div class="col-span-6 sm:col-span-3">

                                    <label for="createInvoiceBankId" class="block mb-2 text-sm font-medium text-gray-900 dark:text-white">Chose a Bank</label>
                                    <select id="createInvoiceBankId" name="bank_id" class="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full p-2.5 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-blue-500 dark:focus:border-blue-500">
                                ...
                                <input type="hidden" id="createInvoiceUserId" value="{{ auth()->user()->id }}" name="user_id">
