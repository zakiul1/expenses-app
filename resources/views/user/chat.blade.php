...
<div class="flex h-screen antialiased text-gray-800">
    <div class="flex flex-row h-full w-full overflow-x-hidden">
      <div class="flex flex-col py-8 pl-6 pr-2 w-64 bg-sky-50 flex-shrink-0">
        ...
        >
          ...
          <div class="flex flex-row items-center mt-3">
            ...
            >
              <div class="h-3 w-3 bg-sky-50 rounded-full self-end mr-1"></div>
            </div>
      ...
      <div class="flex flex-col flex-auto h-full p-6">
        ...
        >
              ...
              <div class="grid grid-cols-12 gap-y-2">
                <div class="col-start-1 col-end-8 p-3 rounded-lg">
                  <div class="flex flex-row items-center">
                    ...
                    <div
                      class="relative ml-3 text-sm bg-sky-50 py-2 px-4 shadow rounded-xl"
                    >
          ...
          <div
            class="flex flex-row items-center h-16 rounded-xl bg-sky-50 w-full px-4"
          >
            <div>
              <button
    ...
    <script>
        const createSmsForm=document.getElementById('createSmsForm');
        console.log(createSmsForm);

        createSmsForm.addEventListener('submit', async (e) => {
            e.preventDefault();

            const formData = new FormData(createSmsForm);

            try {
               
                const response = await axios.post('/user/chat/store', formData);
