                    ...
                    <ol class="inline-flex items-center space-x-1 text-sm font-medium md:space-x-2">
                        <li class="inline-flex items-center">
                            <a href="{{ URL::previous() }}"
                                ...
                                <svg class="w-5 h-5 mr-2  text-sky-500 dark:text-white" aria-hidden="true"
                                    xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 14 10">
                                    <path stroke="currentColor" stroke-linecap="round" stroke-linejoin="round"
                                        stroke-width="2" d="M13 5H1m0 0 4 4M1 5l4-4" />
                                </svg>
                                <span class="text-base text-sky-500"> Back</span>
                            </a>
                        </li>
            ...
            <div class="relative w-full  h-full md:h-auto">
                ...
                <div class="relative p-4 bg-sky-50 rounded-lg shadow dark:bg-gray-800 sm:p-5">
                    ...
                    <div
                        ...
                        <h3 class="text-xl md:text-2xl font-semibold text-gray-500 dark:text-white">
                                    ...
                                    <div class="flex gap-3 flex-wrap  mt-2 items-center mb-2" id="tnxUpdateDocDiv">
                                        ...
                                        @foreach ($documents as $item)
                                            <div class="flex items-center ">
                                                <div
                                                    class="flex items-center justify-center w-10 h-10 mr-3 rounded-lg bg-sky-100 dark:bg-primary-900">
                                                    <svg class="w-5 h-5 text-sky-600 lg:w-6 lg:h-6 dark:text-primary-300"
                        ...
                        <div class="grid gap-4 mb-4 w-full">
                            ...
                            <div class="">
                                ...
                                <textarea id="description" rows="3" name="description"
                                    class="block  p-2.5 w-full text-sm text-gray-900 bg-sky-50 rounded-lg border border-gray-300 focus:ring-primary-500 focus:border-primary-500 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-primary-500 dark:focus:border-primary-500"
                            ...
                            <div class="flex justify-end">
                                <button type="submit"
                                    class="text-white inline-flex items-center bg-sky-500 hover:bg-sky-600 focus:ring-4 focus:outline-none focus:ring-primary-300 font-medium rounded-lg text-sm px-5 py-2.5 text-center dark:bg-primary-600 dark:hover:bg-primary-700 dark:focus:ring-primary-800">
